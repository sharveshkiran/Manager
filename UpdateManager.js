...
export default class UpdateManager extends Component {
    constructor(){
        super();
        this.state={
            Employee:[],
    ...
    update()
    {
        ...
        fetch("http://localhost:50734/api/ManagerDetails/UpdateManager/"+managerId,
        {
            "method":"PATCH",
            "headers": 
            {
        ...
        return (
          ...
          <form>
            ...
            <tr >
                ...
                <input className="spacer" type="text" name="managerId" onChange={(e)=>this.handleChange({managerId:e.target.value})}></input></td>
                </tr>
              <tr >
